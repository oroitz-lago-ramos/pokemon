...
class Enemy_pokemon(game.Pokemon):
    """Classe représentant un pokemon ennemi"""
    def __init__(self, id):
        ...
        self.pokemon_sprite = pygame.image.load(f'assets/images/sprites/face/{self.id}.png') #Ici on charge l'image du pokemon de face